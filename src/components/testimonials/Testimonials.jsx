  ...
  const data = [
    {
      ...
      desc: "Feriel is a good worker, always looking for improvoment and i appreciate her welling to learn more.",
    },
    {
      id: 2,
      name: "Fatma Ben Hfaiedh",
      title: "Instructor in Inco-Academy & Minassa",
